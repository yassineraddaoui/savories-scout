            ...
            <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <div className="flex items-center mb-2 sm:mb-0">
                  <StarRating rating={restaurant.rating} size="lg" showValue={true} />
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{restaurant.neighborhood}, {restaurant.city}</p>
                  </div>
                </div>
                
                <div className="flex items-center">
                  <Phone className="h-5 w-5 mr-2 text-gray-500" />
                  <p className="text-gray-800">{restaurant.phoneNumber}</p>
                </div>
                  ...
                  <div className="space-y-2">
                    {Object.entries(restaurant.openingHours).map(([day, hours]) => (
                      <div key={day} className="flex justify-between">
                        ...
                        <span className="text-gray-600 flex-1">{hours}</span>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <div className="w-full md:w-80 shrink-0">
            <div className="sticky top-4">
              <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                ...
                <div className="aspect-square rounded-md bg-gray-200 mb-3 flex items-center justify-center">
                  <MapPin className="h-12 w-12 text-gray-400" />
                  <span className="sr-only">Map location for {restaurant.name}</span>
                </div>
                <p className="text-gray-700 mb-1">{restaurant.address}</p>
                <p className="text-gray-600 mb-3">{restaurant.neighborhood}, {restaurant.city}</p>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => {
