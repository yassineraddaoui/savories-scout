...
const API_BASE_URL = "/api"; // Adjust this based on your actual API URL
...
export const fetchRestaurants = async (filters?: {
  ...
  let url = `${API_BASE_URL}/restaurant/filter`;
...
export const fetchReviewsByRestaurantId = async (restaurantId: string): Promise<Review[]> => {
  try {
